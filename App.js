    ...
    <View style={styles.container}>
      <View style={styles.card}>
        <Image
          ...
          source={{
            uri: 'https://http2.mlstatic.com/D_NQ_NP_686558-MLB45668100673_042021-O.webp'
          }}
        />

        <View style={styles.productInfo}>
          <Text style={{ fontWeight: 'bold' }}>Xiaomi Mi 11 Lite Ram 6g+128gb Tela 6.55 Amoled Câmera 64mp</Text>
